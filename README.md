...
- [Установка локального сервера](#quick-local-server-setup)
- [Установка локального сервера на Raspberry Pi](#quick-local-server-setup-on-raspberry-pi)
- [Настройка авто перезагрузки сервера на системах Unix(Linux)](#enabling-server-auto-restart-on-unix-like-systems)
- [Настройка авто перезагрузки сервера на Windows](#enabling-server-auto-restart-on-windows)
- [Инструкция по обновлению для Unix (Linux) Систем ](#update-instruction-for-unix-like-systems)
- [Инструкция по обновлению для Windows](#update-instruction-for-windows)
- [Подключения Blynk к локальному серверу](#app-and-sketch-changes)
- [Расширенная настройка локального сервера](#advanced-local-server-setup)
- [Панель администратора](#administration-ui)
- [HTTP/S RESTful API](#https-restful)
- [Включение почты на локальном сервервере](#enabling-mail-on-local-server)
- [Включение SMS на локальном сервере](#enabling-sms-on-local-server)
- [Включение хранилища необработанных данных](#enabling-raw-data-storage)
- [Автоматическое шифрование данных](#automatic-lets-encrypt-certificates-generation)
- [Руководство шифрования SSL/TLS сертефикатов](#manual-lets-encrypt-ssltls-certificates)
- [Создание собственных сертификатов SSL](#generate-own-ssl-certificates)
...
+ Запустить новый сервер [как обычно](# quick-local-server-setup)
